...
<div class="grid grid-cols-3 grid-rows-2 gap-10 font-metropolis">
    <div class="relative bg-base-100 nmorphn w-full max-h-full rounded-3xl shadow dark:bg-gray-800 p-4 md:p-6">
      <div class="bg-primary w-[350px] h-[290px] absolute opacity-75 rounded-xl flex justify-center items-center font-semibold font-metropolis">
        ...
        <div class="bg-base-100 flex justify-between pb-2.5 mb-2.5 border-b border-gray-200 dark:border-gray-700">
          <div class="flex items-center">
            ...
            <div>
              <h5 class="leading-none text-2xl font-bold text-gray-900 dark:text-white pb-1">167 mg/dL</h5>
      ...
      <div class="bg-primary w-[350px] h-[290px] absolute opacity-75 rounded-xl flex justify-center items-center font-semibold font-metropolis">
        ...
        <div class="bg-base-100 flex justify-between pb-2.5 mb-2.5 border-b border-gray-200 dark:border-gray-700">
          <div class="flex items-center">
            ...
            <div>
              <h5 class="leading-none text-2xl font-bold text-gray-900 dark:text-white pb-1">124 mg/dL</h5>
      ...
      <div class="bg-primary w-[350px] h-[290px] absolute opacity-75 rounded-xl flex justify-center items-center font-semibold font-metropolis">
        ...
        <div class="bg-base-100 flex justify-between pb-2.5 mb-2.5 border-b border-gray-200 dark:border-gray-700">
          <div class="flex items-center">
            ...
            <div>
              <h5 class="leading-none text-2xl font-bold text-gray-900 dark:text-white pb-1">4.5 mg/dL</h5>
    ...
    <div id="vs-avg" class="nmorphn relative col-span-2 p-4 rounded-3xl flex flex-row gap-4 content-between">
      ...
      <div class="nmorphu basis-2/3 w-full bg-base-100 rounded-xl shadow dark:bg-gray-800 p-4 md:p-6">
        <div class="flex justify-between">
          <div>
            <h5 class="leading-none text-2xl font-bold text-gray-900 dark:text-white pb-2">32.4k</h5>
